...
async function GET(request, { params }) {
    try {
        ...
        const { data: character, error } = await supabase.from("characters").select("*").eq("characterid", characterId).single();
        if (error || !character) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__75dbeb63._.js.map