...
"[project]/app/api/mobs/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (!mobData.mobName) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Mob name required"
            }, {
                status: 400
            });
        }
        const { data, error } = await supabase.from("mobs").insert([
            {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c8e30039._.js.map