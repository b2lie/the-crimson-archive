...
"[project]/app/api/clips/[clipId]/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(clip, {
            status: 200
        });
    } catch (err) {
...
async function PUT(request, { params }) {
    ...
    try {
        ...
        if (isNaN(clipId) || !clipIdStr) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: "Invalid clip ID format in URL."
            }, {
                status: 400
            });
        }
        ...
        // 2. Database Update
        const { data, error } = await supabase.from("clips").update(clipData).eq("clipid", clipId).select().single();
        if (error || !data) {
            console.error("PUT Clip DB Error:", error?.message);
            const status = error && error.message.includes('permission denied') ? 403 : 400;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Failed to update clip: ${error?.message || 'Data not found.'}`
            }, {
                status: status
            });
        }
...
async function DELETE(request, { params }) {
    ...
    try {
        ...
        const { data, error } = await supabase.from("clips").delete().eq("clipid", clipId).select().single();
        if (error) {
            console.error("DELETE Clip DB Error:", error.message);
            const status = error.message.includes('permission denied') ? 403 : 400;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: `Failed to delete clip: ${error.message}`
            }, {
                status: status
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__f028a685._.js.map