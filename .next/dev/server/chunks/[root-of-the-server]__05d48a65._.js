...
async function GET(request) {
    try {
        ...
        const { data: profile, error: profileError } = await supabase.from('Users').select('*').eq('userID', user.id) // Query based on the linked UUID
        .returns() // Specify the expected return type
...
//# sourceMappingURL=%5Broot-of-the-server%5D__05d48a65._.js.map